...
do
    ...
    do
        ...
        then
            ...
            sed -i "s+</div><div role=\"main\" class=\"document\"+<div class=\"libGraph\"><img src=\"$png\" alt=\"depGraph\" style=\"position:relative;left: 20%;\"></div></div><div role=\"main\" class=\"document\"+" $html
